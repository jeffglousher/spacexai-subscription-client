...
import openai
import pytest
from aiohttp import ClientError, ClientSession, StreamReader
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            [BuiltinTool("web_search")],
            id="hosted-tool-is-not-local-function",
        ),
    ],
)
async def test_completion_rejects_invalid_wire_response(
    wire_client: SpaceXAISubscriptionClient, tools: Sequence[ResponseTool]
) -> None:
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            [BuiltinTool("web_search"), Tool("HassTurnOn", None, {})],
            Completion("", (ToolCall("call-1", "HassTurnOn", {}),)),
            id="hosted-and-local-tools",
        ),
    ],
)
